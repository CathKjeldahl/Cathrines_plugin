...
function bellis_enqueue_styles() {
    wp_enqueue_style('bellis-style', plugin_dir_url(__FILE__) . 'assets/style.css');
}
add_action('wp_enqueue_scripts', 'bellis_enqueue_styles');

// Tilføjer JS
function bellis_enqueue_scripts() {
    wp_enqueue_script('bellis-script', plugin_dir_url(__FILE__) . 'assets/script.js', array('jquery'), null, true);
}
